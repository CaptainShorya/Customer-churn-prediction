...
input_df = pd.concat([geo_encoded_df,input_data.reset_index(drop=True)],axis=1)
...
if prediction > 0.5:
    st.write("Prediction is likely to churn")
else:
    st.write("Prediction is not likely to churn")
